...
* [Datasources]({{< relref "#datasources" >}}) Enhancements for Prometheus, Cloudwatch, PostgreSQL and MySQL. This release also adds support for [Microsft SQL Server]({{< relref "#microsoft-sql-server" >}}) as metric & table datasource!
* [Panels]({{< relref "#panels" >}}) Enhancements for Graph, Table and Singlestat panels.
* [UX improvements]({{< relref "#ux-improvements" >}})
...
New enhancements includes support for adding color to prefix and postfix and additional units. More information in the [Singlestat panel documentation](/features/panels/singlestat/).
